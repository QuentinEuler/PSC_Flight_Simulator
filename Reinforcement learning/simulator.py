...
class SimConnect() :
    def __init__(self, frcs) :
        self.pos = np.array([0,0,200]) # x, y, z in meters
        self.speed = np.array([100,0,0])
    ...
    def compute_state(self, dt=1) :
        ...
        if self.abs_speed()>self.MAX_SPEED:
            self.speed = sp
